...
public class MusicActivity extends AppCompatActivity {
    ...
    private MusicQuestions askQuestions = new MusicQuestions();
        ...
        btnAnswer1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                    ...
                    if(btnAnswer1.getText() == answer)
                    {
                        ...
                        txtScore.setText("Score :" + theScore);
                        updtaeQuestions(theRand.nextInt(theQuestionsLength));
//                        Toast.makeText(MusicActivity.this, "Correct Anwswer",Toast.LENGTH_SHORT).show();
                    }
                    else if(btnAnswer1.getText() != answer)
                    {
//                        Toast.makeText(MusicActivity.this, "Wrong Anwswer",Toast.LENGTH_SHORT).show();
                        updtaeQuestions(theRand.nextInt(theQuestionsLength));
    ...
    public void gameOver()
    {
        ...
        btnQuitGame.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                AlertDialog.Builder arletDialogBuiler = new AlertDialog.Builder(MusicActivity.this);
