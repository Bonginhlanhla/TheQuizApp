...
public class SportActivity extends AppCompatActivity {
    ...
    private SportQuestions askQuestions = new SportQuestions();
        ...
        btnAnswer1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(btnAnswer1.getText() == answer)
                {
                    ...
                    txtScore.setText("Score :" + theScore);
                    updtaeQuestions(theRand.nextInt(theQuestionsLength));
                    Toast.makeText(SportActivity.this, "Correct Anwswer",Toast.LENGTH_SHORT).show();
                }
                else if(btnAnswer1.getText() != answer)
                {
                    Toast.makeText(SportActivity.this, "Wrong Anwswer",Toast.LENGTH_SHORT).show();
    ...
    public void gameOver()
    {
        ...
        btnQuitGame.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                AlertDialog.Builder arletDialogBuiler = new AlertDialog.Builder(SportActivity.this);
